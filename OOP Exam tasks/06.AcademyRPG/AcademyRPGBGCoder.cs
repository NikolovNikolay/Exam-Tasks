...
namespace _06.AcademyRPG
{
    ...
    public class Giant : Character, IFighter, IGatherer
    {
        ...
        public Giant(string name, Point location, int owner)
            : base(name, location, owner)
        {
            this.HitPoints = 200;
        }
    ...
    {
        public House(Point location, int owner)
            : base(location, owner)
        {
            this.HitPoints = 500;
        }
    ...
    {
        public Knight(string name, Point location, int owner)
            : base(name, location, owner)
        {
            this.HitPoints = 100;
        }
    ...
    public class Ninja : Character, IFighter, IGatherer
    {
        ...
        public Ninja(string name, Point location, int owner)
            : base(name, location, owner)
        {
            this.HitPoints = 1;
            this.customAttack = 0;
    ...
    {
        public Rock(Point location, int owner, int hitpoints)
            : base(location, owner)
        {
