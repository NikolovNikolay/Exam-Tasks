...
namespace AcademyEcosystem
{
    ...
    public class Boar : Animal, ICarnivore, IHerbivore
    {
        ...
        {
            int meatEaten = 0;
            if (animal != null && animal.Size <= this.Size && !(animal is Zombie))
            {
                meatEaten = animal.GetMeatFromKillQuantity();
            }
            else if (animal != null && animal is Zombie)
            {
                meatEaten = 10;
            }
    ...
    public class Lion : Animal, ICarnivore
    {
        ...
        {
            int meatEaten = 0;
            if (animal != null && animal.Size <= this.Size * 2 && !(animal is Zombie))
            {
                meatEaten = animal.GetMeatFromKillQuantity();
                this.Size++;
            }
    ...
    public class Wolf : Animal, ICarnivore
    {
        ...
        {
            int meatEaten = 0;
            if ((animal != null && animal.Size <= this.Size && !(animal is Zombie)) || (animal != null && animal.State == AnimalState.Sleeping && !(animal is Zombie)))
            {
                meatEaten = animal.GetMeatFromKillQuantity();
            }
            else if (animal != null && animal is Zombie)
